...
<p style="text-align: center; font-size: 16px;"><img src="https://cdn.auth0.com/blog/universal-login/google-login-mobile.jpg" alt="Google login on mobile app"><br>
...
![unisversal login with GitHub](https://cdn.auth0.com/blog/centralized-login/github-login.jpg)
